        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="flex">
                    ...
                    <a class="text-orange-500 hover:text-orange-600 underline" href="">39 resenas</a>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg mb-6">
                    <div class="p-4 flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-lg font-semibold text-greenLime-600">Se Hace envios a todo el Peru</p>
                            <p class="">Rwcible el
                                {{ Date::now()->addDay(7)->locale('ja')->format('l j F') }}</p>
                        </div>
                    </div>
                </div>
