    ...
    <nav id="navigation-menu" x-show="open" :class="{'block': open, 'hidden' : !open}"
        ...
        <div class="container h-full hidden md:block">
            <div x-on:click.away="close()" class="grid grid-cols-4 h-full relative">
                    ...
                    @foreach ($categories as $category)
                        <li class="navigation-link text-trueGray-500 hover:bg-orange-500 hover:text-white">
                            ...
                            <div class="navigation-submenu bg-gray-100 absolute w-3/4 h-full top-0 right-0 hidden ">
                                {{-- componentのnavigation-subcategoriesにcategoriesを渡す --}}
                ...
                <div class="col-span-3 bg-gray-100 ">
                    {{-- componentのnavigation-subcategoriesにcategories firstを渡す --}}
        ...
        <div class="bg-white h-full overflow-y-auto">
            ...
            @auth
                ...
                <a href="" {{-- event.preventDefault();はクリックをキャンセルする、その後した記のフォームをgetElementById().submitでlogoutを送信する --}} onclick="event.preventDefault();
