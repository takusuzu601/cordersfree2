<div>
    <div class="bg-white rounded-lg shadow-lg mb-6">
        <div class="px-6 py-2 flex justify-between item-center">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        <aside>
            ...
            <ul class="divide-y divide-gray-200">
                @foreach ($category->subcategories as $subcategory)
                    <li class="py-2 text-sm">
                        <a {{-- $setでlivewire  subcategoriaに値をセットしている // 選択中ならば$subcategoria == $subcategory->name ならfontをセミボルドに --}}
            ...
            <h2 class="font-semibold text-center mt-4 mb-2">ブランド</h2>
            <ul class="divide-y divide-gray-200">
                @foreach ($category->brands as $brand)
                    <li class="py-2 text-sm">
                        <a {{-- $setでlivewire  marcaに値をセットしている // 選択中ならば$marca == $brand->name ならfontをセミボルドに --}}
