<div x-data>
    <div>
        ...
        <select wire:model="size_id" class="form-control w-full">
            <option value="" selected disabled>Selection ura talla</option>
    ...
    <div class="mt-2">
        ...
        <select wire:model="color_id" class="form-control w-full">
            <option value="" selected disabled>Selection ura color</option>
    ...
    <div class="flex mt-4">
        <div class="mr-4">
            <x-jet-secondary-button disabled {{-- disabledにqtyが一以下の場合trueが入る --}} x-bind:disabled="$wire.qty <= 1"
        ...
        <div class="flex-1">
            <x-button class="w-full" x-bind:disabled="!$wire.quantity" wire:click="addItem"
                wire:loading.attr="disables" wire:target="addItem">
